...
namespace Collector_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Microsoft.Collector.GuidList.guidCollectorCmdSet, (int)Microsoft.Collector.PkgCmdIDList.StopMonitoring);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Collector", "Microsoft.Collector.CollectorPackage");
