...
using Microsoft.Collector;

namespace Collector_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new CollectorPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Microsoft.Collector.GuidList.guidCollectorCmdSet, (int)Microsoft.Collector.PkgCmdIDList.StopMonitoring);
